...
class VentanaPacientes(QMainWindow):
    ...
    def actualizar_tabla_pacientes(self):
        ...
        for i, paciente in enumerate(pacientes):
            ...
            self.table_pacientes.setItem(i, 11, QTableWidgetItem(paciente.get("motivo_consulta","" )))  # Agregar los datos del motivo de consulta
            self.table_pacientes.setItem(i, 12, QTableWidgetItem(str(len(paciente.get("sesiones", [])))))  # Agregar el número de sesiones del paciente
